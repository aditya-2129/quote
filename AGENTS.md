...
- Feature recognition (Phase 3): `src/utils/features/` — `holes.ts` (`detectHoles(graph)` classifies cylindrical/conical face groups into through/blind/counterbore/countersink with axial chain merging). Future detectors (pocket/slot/fillet/chamfer/thread/boss, issues 022–027) land alongside.
